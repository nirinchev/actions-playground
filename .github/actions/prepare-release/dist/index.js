...
exports.updateChangelogContent = updateChangelogContent;
function hasActualChanges(sectionMatch) {
...
const changelogExtractor_1 = __webpack_require__(582);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const changelogPath = core.getInput("changelog");
            const result = yield changelogExtractor_1.updateChangelogContent(changelogPath);
...
/******/ 	return __webpack_require__(9536);
/******/ })()
;
